(function(g) {
    ...
    */
    ...
    var Kgb = function(a) {
        ...
        Lgb = function(a) {
            ...
            for (var b = 0; b < a.fg.length; b++) {
                ...
                if (!g.Jo(c) || c.Om)
                    if (c.Om || c.m_ !== g.No)(c.N1(c) || Lgb(c)) && c.O1(c), c.Om = !1, c.m_ = g.No;
                if (d !== c.version) return !0
            }
            return !1
        },
        ...
        Tgb = function(a, b, c) {
            var d = typeof c;
            d === "object" || d === "function" ? a[b] = c : Qgb(a, b, c)
        },
        Ugb = function() {
            var a = new Ogb;
            a.__default = Tgb;
        ...
        d4 = function(a, b) {
            ...
            b = Ygb(a, c, a.nodeType === 1 ? d || b : null);
        ...
        $gb = function(a, b) {
            ...
            c || (a === "#text" ? (a = k4.createTextNode(""), Ygb(a, "#text", null)) : (c = k4, d = e4, typeof a === "function" ? c = new a : c = (d = a === "svg" ? "http://www.w3.org/2000/svg" : a === "math" ? "http://www.w3.org/1998/Math/MathML" : d == null || d4(d).B === "foreignObject" ? null : d.namespaceURI) ? c.createElementNS(d, a) : c.createElement(a), Ygb(c, a, b), a = c), g4.created.push(a), c = a);
            a = c;
            if (a !== i4) {
                if (l4.indexOf(a) >= 0)
        ...
        chb = function(a, b) {
            b = b === void 0 ? {} : b;
            var c = b.matches === void 0 ? Zgb : b.matches;
        ...
        ghb = function() {
            var a = Object.assign({}, fhb);
            Object.getOwnPropertyNames(fhb).forEach(function(b) {
        ...
        ihb = function(a) {
            if (p4.b4) {
                ...
                for (b = g.w(a), c = b.next(); !c.done; c = b.next()) c = c.value, a.delete(c), c.Bv()
        },
        khb = function() {
            var a;
            g.J(function(b) {
                if (b.j == 1) return a = jhb, jhb = new Set, g.F(b, Promise.resolve(), 2);
                ihb(a);
                g.va(b)
            })
        },
        lhb = function() {
            return Array.from(hhb).map(function(a) {
                return Array.from(a)
            })
        },
        nhb = function(a) {
            ...
            a = a.nx;
            var d, e = (d = b.OJ) != null ? d : b.name;
            q4.push({
                name: c ? e + " (" + c + ")" : e,
                uR: b.componentType === mhb
            });
            b = a();
            q4.pop();
            return b
        ...
        s4 = function(a, b) {
            ...
            try {
                ...
                throw a = d, ohb(a), a !== phb && (qhb = q4.slice()), phb = a, a;
            } finally {
        ...
        ohb = function(a) {
            ...
            if (b.length !== 0 && !a.PE) {
                ...
                c = a.message + "\n\nComponent stack: " + c;
                try {
                    a.PE = b.slice(), p4.C8 && (a.stack && (a.stack = a.stack.replace(a.message, c)), a.message = c)
                } catch (d) {}
            }
        },
        u4 = function(a) {
        ...
        vhb = function(a) {
            if (a.dF) {
                ...
                try {
                    $3(b, b4(uhb));
                    for (var c = g.w(a.dF), d = c.next(); !d.done; d = c.next()) {
                        var e = d.value;
                        e()
                    }
                } catch (f) {
        ...
        whb = function() {
            g.Lo(this);
            if (g.Jo(this))
                for (var a = 0; a < this.fg.length; a++) g.Ko(this.fg[a], this.xn[a]);
            this.fg.length = this.Qy.length = this.xn.length = 0;
            this.ij && (this.ij.length = this.Lu.length = 0);
            v4.delete(this);
            jhb.delete(this);
            shb(this)
        },
        x4 = function(a, b, c) {
            var d, e;
            var f = {
                PE: (e = (d = qhb) == null ? void 0 : d.slice()) != null ? e : [],
                tA: c === void 0 ? 3 : c,
                Ina: ghb(),
                Mpa: lhb(),
                ypa: t4,
                Npa: [].concat(g.x(xhb.slice(w4)), g.x(xhb.slice(0, w4))),
                tagName: b
            };
            return [a, f]
        },
        ...
        Ahb = function(a, b) {
            yhb++;
            var c = Object.create(zhb);
            c.PE = q4.slice();
            c.wT = a;
            b && (c.OJ = b);
            thb(c);
            if (p4.ifa && (a = g.Go) && a.isAsync) {
                var d;
                (d = p4.handleError) == null || d.call.apply(d, [p4].concat(g.x(x4(Error("Sync reactions can not be called inside a reaction call.")))))
            }
            c.Bv()
        },
        Bhb = function(a) {
        ...
        Ehb = function(a, b, c) {
            if (Object.hasOwnProperty.call(Chb, a) && (a = Chb[a], Object.hasOwnProperty.call(a, b) && (a = a[b], a instanceof Array))) {
        ...
        Ghb = function(a, b, c) {
            ...
            var d = Ehb(a.tagName.toLowerCase(), b, function() {
                var h;
                (h = p4.handleError) == null || h.call.apply(h, [p4].concat(g.x(x4(Error("Contingent attribute/property lookups are not supported."), a.tagName.toLowerCase()))))
            });
            if (d === null) return c;
            d = Fhb[d];
            var e;
            if ((e = d.Hu) == null ? 0 : e.call(d, c)) {
                if (d.qt) return d.qt(c);
                var f;
                (f = p4.handleError) == null || f.call.apply(f, [p4].concat(g.x(x4(Error("Value Handler's unwrap function does not exist."), a.tagName.toLowerCase()))))
            }
            return d.Rr ? d.Rr(a.tagName, b, String(c)) : c
        },
        Ihb = function(a) {
            function b(d, e, f) {
                g.Al(d, Hhb);
                for (var h = Math.min(e.length - f, d.length), l = 0; l < h; l++)
                    if (d[l] !== Hhb(e[f + l])) return !1;
                return !0
            }
            a = String(a);
            for (var c = 0;
        ...
        A4 = function(a, b, c) {
            if (c === !1 && Jhb.has(b)) Qgb(a, b, null);
            else if (b !== "idomKey" && b !== "skip" && b !== "skipchildren" && b !== "children" && b !== "el") {
                if (b.startsWith("on"))
                    if (b[2] === ":") {
                        if (c === void 0 || c === null) {
                            var d;
                            (d = p4.handleError) == null || d.call.apply(d, [p4].concat(g.x(x4(Error("The " + b + " attribute was set to undefined or null. This is not supported and may lead to unexpected behavior if an event handler is being conditionally set."), a.tagName))));
                            a[b] = void 0;
                            return
                        }
                        ...
                        if (typeof c.MY !== "function") throw Error("Expected the event handler for " + b + " to have a 'getFn' property but its keys were: " + (Object.keys(c) + ". Event handlers must be created using useHandler."));
                        var e = c.MY(0),
                            f = b.slice(3);
                        if ((d = r4()) && a["on" + f] === void 0) a.addEventListener(f, e), u4(function() {
                            return void a.removeEventListener(f, e)
                        });
                        else if (d || !Khb.includes(f)) a["on" + f] = e
                    } else {
                        Lhb(a, b, c);
                        return
                    }
                ...
                typeof c !== "function" || a._disposeEffects != null ? (p4.B8 && (c = Ghb(a, b, c)), b === "style" ? Mhb(a, b, c) : b.startsWith("prop:") ? a[b.slice(5)] = c : Lhb(a, b, c)) : (a._signalProps || (a._signalProps = []), a._signalValues || (a._signalValues = []), a._signalProps.push(b))
            }
        },
        Nhb = function(a, b, c) {
            c = (c === void 0 ? {} : c).uR;
            if (b == null ? 0 : b.el) {
                ...
                if (typeof d === "function") d(a);
                    ...
                    var e;
                    (e = d.nca) == null || e.call(d, a);
                    a._disposeRef || (a._disposeRef = function() {
                        var f;
                        (f = d.dda) == null || f.call(d);
        ...
        J4 = function(a) {
            return a instanceof g.Cf || a instanceof g.Ff || a instanceof g.Rf || !1
        },
        Qhb = function(a, b) {
        ...
        Uhb = function(a, b, c) {
            ...
            if (b != null && b[B4]) {
                var d, e, f;
                (f = p4.handleError) == null || f.call.apply(f, [p4].concat(g.x(x4(Error("Encountered a VNode when only real nodes are expected. Tag name: " + ((d = b.type) == null ? void 0 : d.Ft)), (e = b.type) == null ? void 0 : e.Ft))))
            }
            if (a == null) return b == null ? G4() : I4(b) ? H4(b) : J4(b) ? H4(b.toString()) : L4(b) ? b : b.length === 0 ? G4() : N4(b, c);
            if (L4(a)) {
                if (b == null) return Qhb(a, G4());
                if (I4(b)) return Rhb(a, b);
                if (J4(b)) return Rhb(a, b.toString());
                if (L4(b)) return Qhb(a, b);
                if (b.length === 0) return Qhb(a, G4());
                b = N4(b, c);
                Shb([a],
                    c.Qm);
                return b
        ...
        O4 = function(a, b, c) {
            return Whb(a, b != null ? b : [], c === void 0 ? !1 : c)
        },
        N4 = function(a, b) {
            var c = O4(a, void 0, !0);
        ...
        Whb = function(a, b, c, d, e) {
            ...
            if (L4(a)) return Xhb(b, a);
            if (Array.isArray(a)) {
                for (var f = 0; f < a.length; f++) Whb(a[f], b, c, a, f);
                return b
            }
            if (typeof a === "function") return f = Vhb(a)[0], d && c && (d[e] = f), Xhb(b, f);
            if (a != null && a[B4]) {
                a: {
                    d = {
                        stack: [],
            ...
            var h;
            (h = p4.handleError) == null || h.call.apply(h, [p4].concat(g.x(x4(Error("Unrecognized JSXResult type in flattening.")))));
            return b
        },
        Thb = function(a) {
            var b = [];
        ...
        Yhb = function(a, b) {
            ...
            c != null && c.Qm || !Array.isArray(c) || (c = Thb(c));
        ...
        $hb = function(a, b) {
            if (!a.C && b) {
                ...
                try {
                    ...
                    var c, d;
                    (d = p4.handleError) == null || d.call.apply(d, [p4].concat(g.x(x4(e, (c = a.j) == null ? void 0 : c.Ft))))
                }
                S4.RJ(a);
                a.el = null;
            ...
            if (typeof a === "function") return nhb({
                ...
                nx: function() {
                    ...
                    if (a.componentType === mhb) var h = !1;
                        ...
                        f = m;
                        f instanceof HTMLElement ? (f.__instance = h, h.el = f, h.j = a, a.Ft = f.tagName.toLowerCase(), S4.ZE(h), h = f) : h = f
                    }
                    return h ===
                        !1 ? cib(a, b) : h
                }
        ...
        eib = function(a) {
            if (a) {
                ...
                a.__instance && a.__instance instanceof P4 && (b = a.__instance, $hb(b, a), b instanceof R4 && b.G());
                for (b = 0; b < a.childNodes.length; b++) eib(a.childNodes[b])
            }
        },
        gib = function(a) {
            fib.push(a) === 1 && requestAnimationFrame(function() {
                setTimeout(function() {
                    var b = [].concat(g.x(fib));
                    fib = [];
                    b = g.w(b);
                    for (var c = b.next(); !c.done; c = b.next()) {
                        c = c.value;
                        try {
                            for (var d = 0; d < c.length; d++) eib(c[d])
                        } catch (e) {
                            d = c = void 0, (d = (c = p4).handleError) == null || d.call.apply(d, [c].concat(g.x(x4(e))))
                        }
                    }
                })
            })
        ...
        kib = function(a, b) {
            var c = iib("onChange"),
                d = Zhb();
            jib(c.gh, b) && (c.gh = b, c.n1 = a, d.Pz || (d.Pz = []), d.Pz.push(c))
        },
        lib = function(a) {
            var b = t4,
                c = q4.slice();
        ...
        V4 = function(a) {
            var b = [];
            if (r4()) return a();
            var c = iib("useMemoInternal");
            jib(c.gh, b) && (c.gh = b, c.value = a());
            return c.value
        },
        W4 = function() {
            var a = V4(function() {
                return hib(function(b) {
                    a.value = b;
                    var c = function() {
                        var d = {
                            stack: [],
        ...
        rib = function(a, b, c) {
            c = ((c === void 0 ? 0 : c) ? tib : uib)(a, function() {
                X4(b)
            });
            return c === null ? a : c
        },
        X4 = function(a) {
            if (a !== void 0 && a !== null)
                ...
                } else if (a instanceof g.Cf || a instanceof g.Ff || a instanceof g.Rf) ehb(a.toString());
            else if (L4(a)) {
                ...
                var c = typeof a;
                if (c === "boolean" || c === "number" || c === "string") ehb(a);
                    ...
                    if (typeof a.type === "string") {
                        a.Hr || ahb(a.type, a.props.idomKey);
                        b = e4;
                        for (e in a.props) a.props[e] !== vib && (f = a.props[e], c = m4, c.push(e), c.push(f));
                        e = p4.attributes;
                        e = e === void 0 ? wib : e;
                        f = e4;
                        var h = d4(f);
                        c = e;
                        e = m4;
                        h = h.j || (h.j = Pgb(e.length));
                        for (var l = !h.length || !1, m = 0; m < e.length; m += 2) {
                            var n = e[m];
                            if (l) h[m] = n;
                            else if (h[m] !== n) break;
                            var p = e[m + 1];
                            if (l || h[m + 1] !== p) h[m + 1] = p, dhb(f, n, p, c)
                        }
                        if (m < e.length || m < h.length) {
                            for (m =
                                l = m; m < h.length; m += 2) Y4[h[m]] = h[m + 1];
                            for (m = l; m < e.length; m += 2) l = e[m], n = e[m + 1], Y4[l] !== n && dhb(f, l, n, c), h[m] = l, h[m + 1] = n, delete Y4[l];
                            c4(h, e.length);
                            for (d in Y4) dhb(f, d, void 0, c), delete Y4[d]
                        }
                        d = xib;
                        xib = f = o4.length;
                        ...
                        c4(e, 0);
                        aib(b, a.props);
                        (a.props.skip || a.props.skipchildren) && e4.hasChildNodes() ? i4 = e4.lastChild : X4(a.children);
                        h4(null);
                        i4 = e4;
                        e4 = e4.parentNode;
                        a.Hr && (a.Hr = !1);
                    ...
                    if (a.type === D4) X4(a.children);
                        ...
                        try {
                            ...
                            d =
                                q, (f = p4.handleError) == null || f.call.apply(f, [p4].concat(g.x(x4(d, (b = a.type) == null ? void 0 : b.Ft))))
                        }
                        a.Hr && (h4(null), i4 = e4, e4 = e4.parentNode, a.Hr = !1)
                    }
                }
            }
        },
        Aib = function(a, b) {
            var c;
            ((c = a.prototype) == null ? void 0 : c.Zy) === void 0 ? (b = new R4(b), b.B = a) : b = new a(b);
            b.j = a;
            b.wO = {
                eS: b.state,
                g_: !1
        ...
        zib = function(a) {
            var b = a.type,
                c = b.Ft;
            if (b === qib) a.props.children = a.children, b(a.props);
            else {
                a.children.length > 0 && (a.props.children = a.children);
                var d;
                (d = a.props).idomKey || (d.idomKey = b);
                if (c) {
                    var e = ahb(c, a.props.idomKey);
                    a.Hr = !0;
                    var f = e.__instance
                }
                f || (f = Aib(b, a.props), f.props = null, e && (e.__instance = f, f.el = e));
                var h;
                c = ((h = f.wO) != null ? h : {
                    eS: f.state,
                    g_: !1
                ...
                h = function() {
                    ...
                    if (m = l)
                        if (m.Hr = a.Hr, l = X4(m), a.Hr = m.Hr, !b.Ft)
                            if (l) b.Ft = l.tagName.toLowerCase(), l.__instance = f, f.el = l;
                            else {
                                var n;
                                if ((n = f.QA) == null ? 0 : n.length) {
                                    var p;
                                    (p = p4.handleError) == null || p.call.apply(p, [p4].concat(g.x(x4(Error("A component used hooks, but failed to return a host element")))))
                                }
                            }
                    f.ZE();
                    S4.ZE(f)
        ...
        yib = function(a) {
            var b = a.type;
            if (b.componentType !== mhb) return !1;
            a.props.children = a.children.length > 1 ? a.children : a.children[0];
            var c, d = (c = a.props.idomKey) != null ? c : a.type,
                e;
            if (f4() && ((e = f4()[M4]) == null ? void 0 : e.key) === d) {
                d = f4();
                c = d[M4];
                if (!c) throw Error("Reactive data has been lost on node. Tag name: " + d.tagName);
                if (!b.T3) {
                    var f;
                    (f = c.wqa) == null || f.call(c, a.props);
                    Bib(c);
                    return !0
                }
                f = t4;
                b = b.T3(a.props, c.props, f !== null ? f : c.context, c.s$);
                f = Cib(b);
                Dib(a.props, c.props);
                f > 0 ? X4(b) : i4 = f4();
                return !0
            }
            if (Eib.has(b.name) && a.props.allowIdomInterop !==
                Fib) throw Error(b.name + " can not be called from a IDOM component. See go/cow-errors#control-flow-component-called-from-Idom-Component");
            (b = nhb({
                component: a.type,
                debugInstance: a.props.debugInstance,
                nx: function() {
                    return cib(a.type, a.props)
                }
            })) && Gib(b);
            return !0
        },
        ...
        Dib = function(a, b) {
            b && (b.children = a.children, b.A8 = a.A8, b.fallback = a.fallback)
        },
        Hib = function(a) {
            for (var b = 0; b < O4(a).length; b++) i4 = f4()
        },
        Bib = function(a) {
            var b = Iib();
            if (b) Hib(b);
            else
                for (var c = 0; c < a.n0; c++)(b = Iib()) ? Hib(b) : i4 = f4()
        },
        Iib = function() {
            var a;
            return (a = f4()[M4]) == null ? void 0 : a.V2
        },
        Gib = function(a) {
        ...
        Jib = function(a) {
            ...
            return [c.value, function(d) {
                ...
                try {
                    if (Q4 !== null) {
                        var f;
                        (f = p4.handleError) == null || f.call.apply(f, [p4].concat(g.x(x4(Error("Can't set state during rendering")))))
                    }
                    ...
                    if (b.el) {
                        ...
                        try {
                            ...
                            var m, n;
                            (n = p4.handleError) == null || n.call.apply(n, [p4].concat(g.x(x4(p, (m =
                                b.j) == null ? void 0 : m.Ft))))
                        }
                    }
                } catch (p) {
        ...
        Oib = function(a) {
            ...
            Mib.push(a);
            Nib || (b(function() {
                for (var c = g.w(Mib), d = c.next(); !d.done; d = c.next()) d = d.value, d();
                Mib.length = 0;
                Nib = !1
            }), Nib = !0)
        },
        ...
        Qib = function(a) {
            ...
            var c = g.w(Jib("Hide more videos")),
                d = c.next().value,
                e = c.next().value;
            U4(function() {
                var l = a.J;
        ...
        Rib = function(a) {
            ...
            var c = g.w(Pib("More videos")),
                d = c.next().value,
                e = c.next().value,
                f = W4();
            U4(function() {
                a.GM && (a.GM.value = f.value)
            }, [a.GM]);
            U4(function() {
                var h = a.J;
        ...
        Tib = function(a) {
            ...
            U4(function() {
                ...
                g.kp(y.getRootNode(), "ytp-pause-overlay-controls-hidden", B);
                return function() {
            ...
            var t = a.J;
            if (f)
                if (g.kp(t.getRootNode(), "ytp-expand-pause-overlay", !e), e) l.value.focus();
                else {
                    var u = p.value;
                    g.e1(u);
                    u.show();
        ...
        Uib = function(a) {
            ...
            g.P(this, this.G);
            a = a.U();
            this.api.L("embeds_web_enable_pause_overlay_rounding") && g.gp(this.element, "ytp-error-overlay-round-corners");
            this.Y = a.D;
            g.P(this, this.title);
            ...
            this.previous.listen("click", this.e5, this);
            g.P(this, this.oa);
            for (var c = {
                    UA: 0
                }; c.UA < 16; c = {
                ...
                g.nm(e, "transitionDelay", c.UA / 20 + "s");
                this.G.T(e, "click", function(f) {
                    return function(h) {
                        var l = f.UA,
                            m = b.suggestionData[l],
                            n = m.sessionData;
                        g.WO(b.api.U()) && b.api.L("web_player_log_click_before_generating_ve_conversion_params") ? (b.api.logClick(b.j[l].element), l = m.Nl(), m = {}, g.qS(b.api, m), l = g.Ri(l, m), g.QS(l, b.api, h)) : g.PS(h, b.api, b.Y, n || void 0) && b.api.Fp(m.videoId, n, m.playlistId)
                    }
                }(c));
                this.j.push(d)
            }
            ...
            this.next.listen("click", this.d5, this);
        ...
        Wib = function(a) {
            ...
            g.kp(a.element, "ytp-scroll-min", b >= 0);
            g.kp(a.element, "ytp-scroll-max", b <= c)
        },
        Xib = function(a) {
            for (var b = 0; b < a.suggestionData.length; b++) {
                var c = a.suggestionData[b],
                    ...
                    f = c.Nl(),
                    h = a.api.U();
                if (g.WO(h) && !h.L("web_player_log_click_before_generating_ve_conversion_params")) {
                    var l = {};
                    g.xR(a.api, "addEmbedsConversionTrackingParams", [l]);
                    f = g.Ri(f, l)
                }
                d.element.style.display = "";
                l = d.Ea("ytp-suggestion-title");
                g.op.test(c.title) ? l.dir = "rtl" : g.hab.test(c.title) && (l.dir = "ltr");
                l = d.Ea("ytp-suggestion-author");
                g.op.test(e) ? l.dir = "rtl" : g.hab.test(e) && (l.dir = "ltr");
                d.update({
                    views_or_author: e,
        ...
        Z4 = function(a) {
            ...
            c.C ? e.push("no-link") : (c = g.yP(c), d.href = c, d["aria-label"] = "Visit YouTube to search for more videos");
            var f = new g.T({
                I: "a",
                La: e,
                W: d,
            ...
            g.P(this, f);
            a.U().C || (this.j = new Uib(a), this.j.Ia(this.element), g.P(this, this.j));
        ...
        Yib = function(a, b, c) {
            ...
            c = {};
            g.xR(a.api, "addEmbedsConversionTrackingParams", [c]);
            b = g.zg(c) ? b : g.Ri(b, c);
            g.Sf(b)
        },
        Zib = function(a, b) {
        ...
        bjb = function(a, b) {
            var c = a.api.U(),
                d;
            b.reason && ($ib(b.reason) ? d = g.sx(b.reason) : d = g.pY(g.rx(b.reason)), a.Bd(d, "content"));
            var e;
            b.subreason && ($ib(b.subreason) ? e = g.sx(b.subreason) : e = g.pY(g.rx(b.subreason)), a.Bd(e, "subreason"));
            if (b.proceedButton && b.proceedButton.buttonRenderer) {
                d = a.Ea("ytp-error-content-wrap-subreason");
                b = b.proceedButton.buttonRenderer;
                var f = g.bh("A");
                if (b.text && b.text.simpleText && (e = b.text.simpleText, f.textContent = e, !ajb(d, e) && (!c.C || c.embedsErrorLinks))) {
                    var h;
                    c = (h = g.Q(b == null ? void 0 : b.navigationEndpoint, g.Lx)) == null ?
                        void 0 : h.url;
                    var l;
                    h = (l = g.Q(b == null ? void 0 : b.navigationEndpoint, g.Lx)) == null ? void 0 : l.target;
        ...
        cjb = function(a, b) {
            ...
            this.T(this.api, "videoplayerreset", this.tV);
            this.T(this.element,
                "click", this.onClick);
            this.onVideoDataChange();
            this.tV()
        ...
        djb = function(a) {
            var b = {};
            g.xR(a.api, "addEmbedsConversionTrackingParams", [b]);
            a = a.api.getVideoUrl();
            return a = g.Ri(a, b)
        },
        $4 = function(a) {
        ...
        b5 = function(a) {
            ...
            g.T.call(this, {
                ...
                W: {
                    target: b.Y,
                    href: "{{url}}",
                    "aria-label": g.qD("Watch on $WEBSITE", {
                        WEBSITE: g.lP(b)
                    }),
        ...
        ejb = function(a) {
            var b = a.api.getVideoData(),
                c = a.api.U().Cd && !g.Z(a.state, 2) && !g.pR(a.api.getVideoData(1));
            b.mutedAutoplay || g.nx(a, c);
        ...
        hjb = function(a) {
            ...
            this.C = new g.Zo(this.r$, 4E3, this);
            this.B = !1;
            ...
            this.hide();
            g.DR(a.app) && (fjb(this), this.MN(), gjb(this));
            g.P(this, this.C)
        },
        gjb = function(a) {
        ...
        fjb = function(a) {
            a.watermark || (a.watermark = new b5(a.api), g.P(a, a.watermark), a.watermark.Ia(a.bottomButtons, 0), g.kp(a.watermark.element, "ytp-muted-autoplay-watermark", !0), a.j = new g.cy(a.watermark, 0, !0, 100), g.P(a, a.j))
        },
        c5 = function(a) {
            g.T.call(this, {
                I: "div",
            ...
            var b = this;
            this.api = a;
            this.C = new g.DE(this);
            this.D = new g.cy(this, 1E3, !1, 100, function() {
                b.j.B = !1
            }, function() {
                b.j.B = !0
            });
            ...
            a.U().controlsType === "0" && g.gp(a.getRootNode(), "ytp-pause-overlay-controls-hidden");
            this.api.L("embeds_web_enable_pause_overlay_rounding") && g.gp(this.element, "ytp-pause-overlay-round-corners");
            g.P(this, this.C);
            g.P(this, this.D);
            var c = new g.T({
                I: "button",
        ...
        jjb = function(a) {
            a.j || (a.C = 5E3, a.D = (0, g.S)(), a.j = new g.Yo(function() {
                ijb(a)
            }, null), ijb(a))
        },
        ijb = function(a) {
        ...
        njb = function(a) {
            var b = g.v9a(a.J);
            b !== a.Y && (a.Y = b, a.G && (a.G.dispose(), a.G = null), a.C && (a.C.dispose(), a.C = null), a.D && (a.D.dispose(), a.D = null), a.B && (a.B.stop(), a.B.dispose(), a.B = null), b && (b = g.CR(a.J), a.J.fd() && (a.D = new g.T({
                    I: "div",
                    S: "ytp-pause-overlay-backdrop",
                    W: {
                        tabIndex: "-1"
                    }
                }), g.P(a, a.D), g.tS(a.J, a.D.element, 4), a.B = new g.cy(a.D, 1E3, !1, 100), g.P(a, a.B), a.D.hide()), a.G = new g.T({
                    I: "div",
                    S: "ytp-pause-overlay-container",
                    W: {
                        tabIndex: "-1"
                    }
                }), g.P(a, a.G), a.J.L("embeds_web_enable_keto_pause_overlay") ? sib(a.G.element, T4(Tib, {
                    J: a.J,
                    Ne: b
                })) :
                (a.C = new c5(a.J, b), g.P(a, a.C), a.C.Ia(a.G.element)), g.tS(a.J, a.G.element, 4), mjb(a, a.J.getPlayerStateObject())))
        },
        mjb = function(a, b) {
        ...
        kjb = function(a) {
            var b = a.J;
            a = !!b.fd();
            g.kp(b.getRootNode(), "ytp-shorts-mode", a);
            if (b = b.getVideoData()) b.xY = a
        },
        f5 = function(a, b) {
            var c = a.J.U();
            a = {
                ...
                eventType: b,
                youtubeHost: g.Li(a.J.U().Da) || ""
            };
            a.embeddedPlayerMode = c.Ga;
            g.jt("embedsAdEvent", a)
        },
        yhb = 0,
        ojb = 0;
    var rhb = Symbol("DISABLE_ON_CLEANUP");
    var t4 = null;
    var uhb = g.Po(!0);
    var fhb = {
        B8: !0,
    ...
    var Rgb = Object.prototype.hasOwnProperty;
    Ogb.prototype = Object.create(null);
    var wib = Ugb();
    var n4 = null;
    var bhb = typeof Node !== "undefined" && Node.prototype.getRootNode || function() {
    ...
    var g5 = {},
        rjb = Object.assign({}, {
            Yoa: !0
        }, g.Oo, (g5.fg = void 0, g5.UQ = !1, g5.wT = null, g5.pP = !0, g5.RE = !1, g5[Symbol.dispose] = whb, g5.PE = void 0, g5.OJ = "[reaction]", g5.Bv = function() {
            if (this.wT !== null && !this.Ja) {
                if (g.Io) throw Error("Schedulers cannot synchronously execute effects while scheduling.");
                this.Om = !1;
                if (!this.UQ || Lgb(this)) {
                    this.UQ = !0;
                    ojb++;
                    ...
                    try {
                        ...
                        g.tla(this, b), t4 = a, xhb[w4] = this.OJ, w4 = (10 + w4 + 1) % 10
                    }
                }
            }
        }, g5));
    var zhb = Object.assign({}, rjb, {
        qP: function(a) {
            a.Ja || v4.add(a)
        },
        RE: !1
    });
    var Jhb = new Set("allowfullscreen async autofocus autoplay checked controls default defer disabled formnovalidate hidden ismap itemscope jsshadow jsslot loop multiple muted novalidate open playsinline readonly required reversed scoped seamless selected spellcheck sortable typemustmatch".split(" "));
    var Dhb = {
            align: 1,
            alt: 1,
    ...
    var sjb = /^(?!javascript:)(?:[a-z0-9+.-]+:|[^&:\/?#]*(?:[\/?#]|$))/i,
        ...
        Fhb = (h5[1] = {
            ...
            Rr: function() {
                return g.Jf.toString()
            },
            Hu: function(a) {
                return a instanceof g.Of
            },
            qt: function(a) {
                return g.Qf(a)
            }
            ...
            Rr: function(a, b, c) {
                return sjb.test(c) ? c : g.Jf.toString()
            },
            Hu: function(a) {
                return a instanceof g.Ff
            },
            qt: function(a) {
                return g.Gf(a)
            }
    ...
    var vib = Symbol("ATTR_TAG_VALUE");
    RegExp.prototype.hasOwnProperty("sticky");
    var tjb = Ugb(),
        Lhb = tjb.__default,
        Mhb = tjb.style,
        Khb = ["focusin", "focusout"];
    ...
    P4.prototype.ZE = function() {};
    P4.prototype.q8 = function() {};
    P4.prototype.RJ = function() {};
    P4.prototype.r8 = function() {};
    var Q4 = null;
    g.z(R4, P4);
    R4.prototype.Zy = function(a) {
        var b = Q4;
        Q4 = this;
        this.D = 0;
        try {
    ...
    var fib = [];
    g.Mo = function() {
        var a = g.Go === uhb ? Error("A Signal Setter was called within onCleanup, which can lead to infinite update loops. See go/cow-errors#signal-write-in-oncleanup for more information.") : g.Go === g.t1 ? Error("A Signal Setter was called during rendering, which can lead to consistency issues. See go/cow-errors#signal-write-during-rendering for more information.") : Error("A Signal Setter was called within a Reaction, which can lead to infinite update loops. See go/cow-errors#signal-write-in-a-reactive-context for more information.");
        if (p4.I$) throw a;
        var b;
        (b = p4.handleError) == null || b.call.apply(b, [p4].concat(g.x(x4(a, "", 2))))
    };
    (function() {
        var a = n4;
        n4 = function(b) {
    ...
    (function(a) {
        ...
        for (c in a) b = {
            G1: void 0,
            f0: void 0
        }, b.G1 = S4[c], b.f0 = a[c], S4[c] = function(d) {
            return function() {
                var e = g.Da.apply(0, arguments);
                d.G1.apply(null, g.x(e));
                d.f0.apply(null, g.x(e))
            }
        }(b)
    })({
        DX: function(a) {
            ...
            try {
                $3(b, y4(a.UJ));
                var c;
                ((c = a.Pz) == null ? 0 : c.length) && oib(a.Pz)
            } catch (d) {
                b.error = d, b.hasError = !0
            } finally {
                a4(b)
        ...
        RJ: function(a) {
            var b;
            ((b = a.QA) == null ? 0 : b.length) && a.QA.forEach(nib)
        }
    });
    var Fib = Symbol("ALLOW_IDOM_INTEROP_SYMBOL");
    F4 = dib;
    var Eib = new Set(["For", "If", "Match", "Watch"]),
        ujb = {},
        vjb = (ujb.__default = function() {
            return A4
        }, ujb.style = function() {
            return A4
        }, ujb),
        i5;
    for (i5 in vjb) p4.attributes[i5] = vjb[i5](p4.attributes[i5]);
    var Mib = [],
        Nib = !1;
    Qib.componentType = qjb;
    Rib.componentType = qjb;
    Tib.componentType = qjb;
    g.z(Uib, g.T);
    g.k = Uib.prototype;
    g.k.hide = function() {
        this.N = !0;
    ...
    g.k.resize = function(a, b) {
        ...
        if (Math.min(a.width, a.height) <= 150 || h === 0 || !c.Ad) this.hide();
            ...
            b && q + 100 > b && m > 50 && (q = Math.max(b, 50 / d), l = Math.ceil(a / (d * (q - 100) + this.B)), m = a / l - this.B,
                q = Math.floor(m / d));
            m < 50 || g.mS(this.api) ? this.hide() : this.show();
            for (b = 0; b < h; b++) {
                d = this.j[b];
    ...
    g.k.onVideoDataChange = function() {
        var a = this.api.getVideoData(),
            b = this.api.U();
        this.Y = a.Jf ? !1 : b.D;
        a.suggestions ? this.suggestionData = g.jn(a.suggestions, function(c) {
            return c && !c.playlistId
        }) : this.suggestionData.length = 0;
        Xib(this);
        a.Jf ? this.title.update({
            title: g.qD("More videos from $DNI_RELATED_CHANNEL", {
    ...
    g.k.scrollTo = function(a) {
        a = g.Gg(a, this.containerWidth - this.suggestionData.length * (this.D + this.B), 0);
    ...
    Z4.prototype.show = function() {
        g.oY.prototype.show.call(this);
        Zib(this, this.api.ob().getPlayerSize())
    };
    Z4.prototype.resize = function(a) {
        g.oY.prototype.resize.call(this, a);
        this.j && (Zib(this, a), g.kp(this.element, "related-on-error-overlay-visible", !this.j.isHidden()))
    };
    Z4.prototype.B = function(a) {
        g.oY.prototype.B.call(this, a);
        var b = this.api.getVideoData();
        if (b.kE || b.playerErrorMessageRenderer)(a = b.kE) ? bjb(this, a) : b.playerErrorMessageRenderer && bjb(this, b.playerErrorMessageRenderer);
        else {
            var c;
            a.oo && (b.Hw ? $ib(b.Hw) ? c = g.sx(b.Hw) : c = g.pY(g.rx(b.Hw)) : c = g.pY(a.oo), this.Bd(c, "subreason"))
        }
    };
    g.z(cjb, g.T);
    g.k = cjb.prototype;
    g.k.onVideoDataChange = function() {
        var a = this.api.getVideoData(),
            b = Mgb(),
            c = 96714;
        g.qR(a) ? (b = Ngb(), c = 216165, g.gp(this.element, "ytp-music-impression-link")) : g.ip(this.element, "ytp-music-impression-link");
    ...
    g.k.tV = function() {
        var a = this.api.getVideoData(),
            ...
            f = this.Ne.Pg();
        b = b.C;
        d || f || c || e || b || this.api.fd() || !a.videoId ? (this.hide(), this.api.logVisibility(this.element, !1)) : (a = djb(this), this.updateValue("url", a), this.show())
    };
    ...
    g.z($4, g.T);
    $4.prototype.Nk = function() {
        var a = this.api.getPlayerStateObject();
        !this.api.Nh() || g.Z(a, 2) && g.OR(this.api) || g.Z(a, 64) ? (this.api.logVisibility(this.j, !1), this.api.logVisibility(this.forwardButton, !1), this.hide()) : (this.show(), this.api.logVisibility(this.j, !0), this.api.logVisibility(this.forwardButton, !0))
    };
    ...
    a5.prototype.C = function() {
        var a = this.api.getPlayerStateObject();
        this.api.getVideoData().mutedAutoplay && (g.Z(a, 2) && !this.Fb ? (this.show(), this.j || (this.j = new g.mY(this.api), g.P(this, this.j), this.j.Ia(this.D, 0), this.j.show()), a = this.api.getVideoData(), this.updateValue("text", a.JW), g.kp(this.element, "ytp-muted-autoplay-show-end-panel", !0), this.api.logVisibility(this.element, this.Fb), this.api.yd("onMutedAutoplayEnds")) : this.hide())
    };
    a5.prototype.onClick = function() {
        if (!this.B) {
            this.j && (this.j.xa(), this.j = null);
            g.kp(this.api.getRootNode(), "ytp-muted-autoplay", !1);
            var a = this.api.getVideoData(),
    ...
    g.k.onVideoDataChange = function() {
        var a = this.api.U();
        a.C && g.gp(this.element, "ytp-no-hover");
        var b = this.api.getVideoData();
    ...
    g.k.onClick = function(a) {
        this.api.L("web_player_log_click_before_generating_ve_conversion_params") && this.api.logClick(this.element);
        var b = this.api.getVideoUrl(!g.Ay(a), !1, !0, !0);
        if (this.api.L("web_player_log_click_before_generating_ve_conversion_params")) {
            var c = {};
            g.xR(this.api, "addEmbedsConversionTrackingParams", [c]);
            b = g.Ri(b, c)
        }
        g.QS(b, this.api, a);
        this.api.L("web_player_log_click_before_generating_ve_conversion_params") || this.api.logClick(this.element)
    ...
    c5.prototype.hide = function() {
        g.ip(this.api.getRootNode(), "ytp-expand-pause-overlay");
        g.T.prototype.hide.call(this)
    };
    ...
    c5.prototype.K = function() {
        this.B = !1;
        g.gp(this.api.getRootNode(), "ytp-expand-pause-overlay");
        this.api.fd() && this.api.logVisibility(this.element, !0);
        this.focus()
    };
    c5.prototype.Sa = function() {
        var a = this.api.getPlayerStateObject();
        g.Z(a, 1) || g.Z(a, 16) || g.Z(a, 32) || (!g.Z(a, 4) || g.Z(a, 2) || g.Z(a, 1024) ? (this.B || this.api.logVisibility(this.element, !1), this.D.hide()) : this.j.suggestionData.length > 0 && (this.B || (g.gp(this.api.getRootNode(), "ytp-expand-pause-overlay"), g.e1(this.j), this.j.show(), this.api.logVisibility(this.element, !0)), this.D.show()))
    };
    g.z(d5, g.T);
    ...
    g.k.create = function() {
        ...
        a.Xa && !a.disableOrganicUi && njb(this);
        this.Z = new hjb(this.J);
        g.P(this, this.Z);
        g.tS(this.J, this.Z.element, 4);
        this.qa = new a5(this.J);
        g.P(this, this.qa);
        g.tS(this.J, this.qa.element, 4);
        a.Cd && (this.watermark = new b5(this.J), g.P(this, this.watermark), g.tS(this.J, this.watermark.element, 8));
        b && !a.disableOrganicUi && (this.K = new cjb(this.J, b), g.P(this, this.K), g.tS(this.J,
            this.K.element, 8), g.DR(this.J.app) && (this.onMutedAutoplayStarts(), this.K.hide()));
        a.B && !a.disableOrganicUi && (this.oa = new $4(this.J), g.P(this, this.oa), g.tS(this.J, this.oa.element, 4));
        ...
        if (this.N = g.js(g.eP(a))) this.countdownTimer = new d5(this.J), g.P(this, this.countdownTimer), g.tS(this.J, this.countdownTimer.element, 4), this.countdownTimer.hide(), this.j.T(this.J, g.fD("embeds"), this.onCueRangeEnter), this.j.T(this.J, g.gD("embeds"), this.onCueRangeExit);
        this.Ec(this.J.getPlayerStateObject());
        this.player.Fg("embed");
        var e, f;
        ((e = this.J.U().getWebPlayerContextConfig()) ==
            null ? 0 : (f = e.embedsHostFlags) == null ? 0 : f.allowOverridingVisitorDataPlayerVars) && (a = g.Uq("IDENTITY_MEMENTO")) && this.J.qf("onMementoChange", a)
    };
    g.k.onCueRangeEnter = function(a) {
        a.getId() === "countdown timer" && this.countdownTimer && (this.countdownTimer.show(), jjb(this.countdownTimer))
    };
    ...
    g.k.Ec = function(a) {
        g.Z(a, 128) ? (this.zg || (this.zg = new Z4(this.J), g.P(this, this.zg), g.tS(this.J, this.zg.element, 4)), this.zg.B(a.hh), this.zg.show(), g.gp(this.J.getRootNode(), "ytp-embed-error")) : this.zg && (this.zg.dispose(), this.zg = null, g.ip(this.J.getRootNode(), "ytp-embed-error"));
        if (this.countdownTimer && this.countdownTimer.j)
            ...
            (b = this.countdownTimer, b.B && (b.D += (0, g.S)() - b.G, b.B = !1, ijb(b)));
        mjb(this, a)
    };
    g.k.onMutedAutoplayStarts = function() {
        this.J.getVideoData().mutedAutoplay && this.Z && g.kp(this.J.getRootNode(), "ytp-muted-autoplay", !0)
    };
    g.k.onVideoDataChange = function(a, b) {
        var c = this.sG !== b.videoId;
        a = !c && a === "dataloaded";
        var d = {
            isShortsModeEnabled: !!this.J.fd()
        };
        g.jt("embedsVideoDataDidChange", {
            clientPlaybackNonce: b.clientPlaybackNonce,
            isReload: a,
            runtimeEnabledFeatures: d
        });
        c && (this.sG = b.videoId, this.countdownTimer && (this.countdownTimer.show(), this.countdownTimer.hide()), this.N && (this.J.rf("embeds"), b.isAd() || b.limitedPlaybackDurationInSeconds < 5 || g.mS(this.J) || (b = Math.max((b.startSeconds + b.limitedPlaybackDurationInSeconds - 5) * 1E3, 0),
            b = new g.dD(b, b + 5E3, {
                id: "countdown timer",
                namespace: "embeds"
            }), this.J.jf([b]))), this.J.U().Xa && !this.J.U().disableOrganicUi && (kjb(this), njb(this)));
