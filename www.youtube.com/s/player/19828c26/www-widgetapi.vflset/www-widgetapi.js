(function() {
    ...
    function oa(a) {
        ...
        return new Promise(function(d, f) {
            function k(e) {
                e.done ? d(e.value) : Promise.resolve(e.value).then(b, c).then(k, f)
            }
            k(a.next())
        })
    }
    ...
    u("Promise", function(a) {
        ...
        b.prototype.J = function(e) {
            ...
            typeof g == "function" ? this.N(g, e) : this.m(e)
        };
        ...
        b.prototype.u = function(e, g) {
            if (this.h != 0) throw Error("Cannot settle(" + e + ", " + g + "): Promise already settled in state" + this.h);
            this.h = e;
            this.i = g;
            this.h === 2 && this.L();
            this.B()
        ...
        b.prototype.T = function() {
            ...
            typeof e === "function" ? e = new e("unhandledrejection", {
                cancelable: !0
            }) : typeof g === "function" ? e = new g("unhandledrejection", {
                cancelable: !0
        ...
        b.prototype.then = function(e, g) {
            function h(q, A) {
                return typeof q == "function" ? function(ca) {
                    try {
                        l(q(ca))
                    } catch (da) {
                        m(da)
        ...
        b.race = function(e) {
            return new b(function(g, h) {
                for (var l = v(e), m = l.next(); !m.done; m = l.next()) d(m.value).A(g, h)
            })
        };
        b.all = function(e) {
            var g = v(e),
    ...
    u("Map", function(a) {
        ...
        f.prototype.forEach = function(g, h) {
    ...
    u("Set", function(a) {
        ...
        if (function() {
                ...
                try {
                    ...
                    k = f.next();
                    return k.done || k.value[0] == c || k.value[0].x != 4 || k.value[1] != k.value[0] ? !1 : f.next().done
                } catch (e) {
                    return !1
                }
            }()) return a;
    ...
    u("Array.from", function(a) {
        return a ? a : function(b, c, d) {
            ...
            if (typeof k == "function") {
                b = k.call(b);
                for (var e = 0; !(k = b.next()).done;) f.push(c.call(d, k.value, e++))
            } else
                for (k = b.length, e = 0; e < k; e++) f.push(c.call(d, b[e], e));
            return f
        }
    });
    /*
    ...
    */
    ...
    var ya = Array.prototype.indexOf ? function(a, b) {
        ...
        I = Array.prototype.forEach ? function(a, b, c) {
            ...
            for (var d = a.length, f = typeof a === "string" ? a.split("") : a, k = 0; k < d; k++) k in f && b.call(c, f[k], k, a)
        };
    ...
    */
    ...
    var Ka = new J("about:invalid#zClosurez");
    ...
    var Ma = [K("data"), K("http"), K("https"), K("mailto"), K("ftp"), new La(function(a) {
        return /^[^:]*([/?#]|$)/.test(a)
    })];

    function Na(a) {
        var b = b === void 0 ? Ma : b;
        a: if (b = b === void 0 ? Ma : b, !(a instanceof J)) {
            for (var c = 0; c < b.length; ++c) {
                var d = b[c];
                if (d instanceof La && d.S(a)) {
                    a = new J(a);
                    break a
                }
            }
    ...
    function L(a, b) {
        b = Error.call(this, a + " cannot be used with intent " + Pa[b]);
        ...
        for (var N in M)
            if (N != "prototype")
                if (Object.defineProperties) {
                    var Qa = Object.getOwnPropertyDescriptor(M, N);
                    Qa && Object.defineProperty(L, N, Qa)
                } else L[N] = M[N];
    L.I = M.prototype;
    ...
    function Ra(a, b) {
        ...
        if (b instanceof J)
            if (b instanceof J) b = b.g;
            else throw Error("");
        else b = Oa.test(b) ? b : void 0;
        b !== void 0 && (a.src = b)
    };

    function Sa(a) {
        Ja.test(a) && (a.indexOf("&") != -1 && (a = a.replace(Da, "&amp;")), a.indexOf("<") != -1 && (a = a.replace(Ea, "&lt;")), a.indexOf(">") != -1 && (a = a.replace(Fa, "&gt;")), a.indexOf('"') != -1 && (a = a.replace(Ga, "&quot;")), a.indexOf("'") != -1 && (a = a.replace(Ha, "&#39;")), a.indexOf("\x00") != -1 && (a = a.replace(Ia, "&#0;")));
        return a
    };
    var Ta, O;
    a: {
        for (var Ua = ["CLOSURE_FLAGS"], P = F, Va = 0; Va < Ua.length; Va++)
            if (P = P[Ua[Va]], P == null) {
                O = null;
                break a
            }
    ...
    var Q, Ya = F.navigator;
    Q = Ya ? Ya.userAgentData || null : null;

    function Za() {
        return Ta ? Q ? Q.brands.some(function(a) {
    ...
    function bb() {
        for (var a = Xa(), b = RegExp("([A-Z][\\w ]+)/([^\\s]+)\\s*(?:\\((.*?)\\))?", "g"), c = [], d; d = b.exec(a);) c.push([d[1], d[2], d[3] || void 0]);
        a = ab(c);
        return ($a() ? Za() : (R("Chrome") || R("CriOS")) && ($a() || !R("Edge")) || R("Silk")) ? a(["Chrome", "CriOS", "HeadlessChrome"]) : ""
    }

    function cb() {
        if ($a()) {
            var a = Q.brands.find(function(b) {
    ...
    function fb() {
        ...
        typeof a === "undefined" && typeof window !== "undefined" && window.postMessage && window.addEventListener && !R("Presto") && (a = function() {
            var f = db();
            ...
            f = wa(function(h) {
                if ((g == "*" || h.origin == g) && h.data == e) this.port1.onmessage()
            }, this);
            k.addEventListener("message", f, !1);
            this.port1 = {};
            this.port2 = {
    ...
    p.H = function(a, b) {
        var c = this.h[a];
        if (c) {
            for (var d = Array(arguments.length - 1), f = 1, k = arguments.length; f < k; f++) d[f - 1] = arguments[f];
            if (this.u)
                for (f = 0; f < c.length; f++) {
                    var e = c[f];
                    qb(this.g[e + 1], this.g[e + 2], d)
                } else {
                    this.m++;
                    try {
                        for (f = 0, k = c.length; f < k && !this.i; f++) e = c[f], this.g[e + 1].apply(this.g[e + 2], d)
                    } finally {
                ...
                case 2:
                    ...
                    return C(c, Promise.all(b.map(function(d) {
                        ...
                        return pa(function(k) {
                            ...
                            k.g != 2 ? (f = k.m, f.state === "prompt" && a.g.push(d), k.g = 0, k.l = 0) : (k.l = 0, k.i = null, k.g = 0)
                        })
                    })), 4);
                case 4:
    ...
    function Gb(a, b, c) {
        Y || (Y = {}, Hb = new Set, Ib.addEventListener("message", function(d) {
            a: if (Hb.has(d.origin)) {
                ...
                var k = Y[f.id];
                if (k && d.origin === k.O) switch (d = k.U, d.s = !0, d.s && (I(d.m, d.sendMessage, d), d.m.length = 0), k = f.event, f = f.info, k) {
                    case "apiInfoDelivery":
                        if (G(f))
                            for (var e in f) f.hasOwnProperty(e) && (d.v[e] = f[e]);
                        break;
                    case "infoDelivery":
                        Jb(d, f);
                        break;
                    case "initialDelivery":
                        G(f) && (clearInterval(d.i), d.playerInfo = {}, d.v = {}, Kb(d, f.apiInterface), Jb(d, f));
                        break;
                    default:
                        d.j.i ||
                            (e = {
    ...
    function Z(a, b) {
        ...
        if (a = typeof a === "string" ? c.getElementById(a) : a)
            if (Nb.yt_embedsEnableRsaforFromIframeApi && zb(), c = a.tagName.toLowerCase() === "iframe", b.host || (b.host = c ? sb(a.src) : "https://www.youtube.com"), this.h =
                new Fb(b), c || (b = Ob(this, a), this.l = a, (c = a.parentNode) && c.replaceChild(b, a), a = b), this.g = a, this.g.id || (this.g.id = "widget" + ra(this.g)), W[this.g.id] = this, window.postMessage) {
                this.j = new U;
                Pb(this);
                b = X(this.h, "events");
                for (var d in b) b.hasOwnProperty(d) && this.addEventListener(d, b[d]);
                for (var f in Bb) Bb.hasOwnProperty(f) && Qb(this, f)
            }
    }
    p = Z.prototype;
    ...
    function Ob(a, b) {
        ...
        Nb.yt_embedsEnableIframeApiSendFullEmbedUrl && (window.location.href && (e.forigin = window.location.href), b = window.location.ancestorOrigins, e.aoriginsup = b === void 0 ? 0 : 1, b && b.length > 0 && (e.aorigins = Array.from(b).join(",")), window.document.referrer && (e.gporigin = window.document.referrer));
        a = "" + X(a.h, "host") + ("/embed/" + X(a.h, "videoId")) + "?" + ub(e);
        Nb.yt_embedsEnableIframeSrcWithIntent ? (Ra(c, Na(a)), c.sandbox.add("allow-presentation", "allow-top-navigation")) : c.src = a;
        return c
    }
    p.G = function() {
        ...
        I(b, function(c) {
            this[c] || (c === "getCurrentTime" ? this[c] = function() {
                ...
                if (this.playerInfo.playerState === 1) {
                    var f = (Date.now() / 1E3 - this.playerInfo.currentTimeLastUpdated_) * this.playerInfo.playbackRate;
                    f > 0 && (d += Math.min(f, 1))
                }
                return d
    ...
    p.getVideoEmbedCode = function() {
        ...
        a = Sa(a);
        d = Sa(d != null ? d : "YouTube video player");
    ...
    Ab.push(function(a) {
        ...
        if (c.querySelectorAll && c.querySelector) b = c.querySelectorAll(".yt-player");
            ...
            if (b.querySelectorAll && b.querySelector) b = b.querySelectorAll(".yt-player");
                ...
                var f = b.getElementsByClassName("yt-player");
                b = f
            } else {
                ...
                for (c = d = 0; b = f[c]; c++) {
                    var e = b.className,
                        g;
                    if (g = typeof e.split == "function") g = ya(e.split(/\s+/),
                        "yt-player") >= 0;
                    g && (k[d++] = b)
                }
                k.length = d;
    ...
    var Vb = F.onYTReady;
    Vb && Vb();
    var Wb = F.onYouTubeIframeAPIReady;
    Wb && Wb();
    var Xb = F.onYouTubePlayerAPIReady;
    Xb && Xb();
}).call(this);